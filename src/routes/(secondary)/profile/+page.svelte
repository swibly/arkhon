...
<main class="xl:flex w-full min-h-screen justify-end">
    <aside
    ...
    >
        ...
        <section class="flex flex-col justify-center items-center h-full">
            ...
            <div class="mx-0 sm:mx-20 xl:grid xl:place-items-center xl:block xl:mx-0 xl:pt-0">
                ...
                <button class="hidden xl:block btn btn-secondary w-72 text-lg hover:btn-secondary"
    ...
    <main class="w-full xl:w-4/6 min-h-screen bg-base-100">
        ...
        <section class="w-full grid place-items-center py-12 px-8 sm:px-20 xl:hidden">
            {#if option === 'projects'}
                <h1 class="text-3xl text-secondary text-center font-bold text-center xl:text-left">
                    Projetos Recentes
                </h1>
