            ...
            <div class="grid grid-cols-2 gap-8 pt-12 mx-12">
                ...
                <div class="col-span-2">
                    ...
                    <p class="text-xl pt-4 text-justify">
                        ...
                        projetadas para simplificar o processo de criação de plantas arquitetônicas.
                        Desde a concepção inicial até a apresentação final, nossas ferramentas
                        avançadas garantem precisão e flexibilidade em cada etapa do projeto.
                    </p>
                </div>
            </div>
            <div>
                ...
                <div class="w-full grid grid-cols-3 place-items-center pt-12 space-x-12">
                    ...
                    >
                        ...
                        <p class="text-lg text-center">
                            A plataforma Arkhon é fácil de usar, permitindo criar e ajustar plantas
                            arquitetônicas rapidamente.
                        </p>
                    </div>
                    <div
                        class="w-80 h-80 bg-base-300 border-2 border-secondary rounded-2xl flex flex-col justify-center items-center px-6"
                    >
                        ...
                        <p class="text-lg text-center">
                            O Arkhon oferece uma ampla biblioteca de componentes, desde estruturas a
                            decorações, para personalização das plantas.
                        </p>
                    </div>
                    <div
                        class="w-80 h-80 bg-base-300 border-2 border-secondary rounded-2xl flex flex-col justify-center items-center px-6"
                    >
                        ...
                        <p class="text-lg text-center">
                            A plataforma facilita a colaboração entre usuários, ideal para trabalho
                            em equipe em ambientes profissionais.
                        </p>
                    </div>
                </div>
            </div>
