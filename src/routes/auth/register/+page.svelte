...
<main class="bg-primary w-full min-h-screen max-w-[800px] mx-auto bleed">
    <h1 class="text-center text-4xl sm:text-5xl px-4 font-bold text-white pt-12">
    ...
    <section class="mx-12 mt-8">
        <form>
            <div class="lg:flex justify-center gap-2">
                <label class="input input-bordered flex items-center gap-2 mb-8 lg:flex-1">
            ...
            <label class="input input-bordered flex items-center gap-2 mt-4 mb-8">
